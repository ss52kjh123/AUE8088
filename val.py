...
def load_kaist_img_id_map(ann_file='/home/ss52kjh123/Downloads/AUE8088/utils/eval/KAIST_val-D_annotation.json'):
    """
        ...
        jdict.append(
            {
                ...
                "image_id": int(image_id),  # KAIST 데이터셋과 일치하는 ID 사용
